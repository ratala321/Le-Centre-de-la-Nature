...
func previsualiserPlanteDansSacGraines(aireDetectionSolFertile : Area3D, graineContenue : PackedScene):
...
func _effectuerProcedureDetection(aireEnCollision) -> bool:
		return _estEspacePlante(aireEnCollision)


const espacePlanteGroupe : String = "EspacePlante"
func _estEspacePlante(aireEnCollision) -> bool:
